...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      'Browse all products & company pages',
      'Appear in your local market',
      'Receive buyer enquiries',
      'Basic company page',
      'Contact / order is unlocked on a paid plan',
    ],
  },
  {
    tier: 'standard',
    ...
    price: '€79',
    period: '/mo',
    tagline: 'Open your retail shop and connect with your distributors.',
    bestFor: 'Retail shops',
    accent: '#2563eb',
    highlight: true,
    features: [
      'Create your own online store',
      'Sell at retail (local · province · nationwide)',
      'Receive direct customer enquiries',
      'Connect with your distributors',
  ...
  },
  {
    ...
    price: '€158',
    period: '/mo',
    tagline: 'Add B2B access — buy wholesale and reach suppliers.',
    bestFor: 'Retail + B2B (Retail €79 + €79)',
    accent: '#7c3aed',
    features: [
      'Everything in the Retail Plan',
      'Unlock the Suppliers directory',
      'See wholesale pricing & MOQ',
      'Buy from suppliers worldwide',
      'Priority enquiries',
      'Does not include Factory access',
    ],
  },
  {
    tier: 'full',
    ...
    price: '€210',
    period: '/mo',
    tagline: 'Reach the source — full access to factories & manufacturers.',
    bestFor: 'Sourcing direct from factories',
    accent: '#0B1F4D',
    features: [
      'Everything in the B2B Plan',
      '🏭 Unlock the Factories directory',
...
/** The growth levels shown on the pricing page. */
export const GROWTH_LEVELS: { icon: string; title: string; sub: string; price: string }[] = [
  { icon: '🛒', title: 'Retail', sub: 'Open your shop & sell to customers.', price: 'Free / €79' },
  { icon: '🤝', title: 'B2B', sub: 'Buy wholesale & reach suppliers.', price: '€158 / mo' },
  { icon: '🏭', title: 'Factory', sub: 'Source direct from manufacturers worldwide.', price: '€210 / mo' },
]
...
export const PRESENTED_BY_ROLE: { role: string; presented: string }[] = [
  { role: 'Shop / Retailer',          presented: 'Distributors (€79) → Suppliers (B2B €158) → Factories (€210)' },
  { role: 'Supplier / Distributor',   presented: 'Factories (their counterpart) + Retail, included' },
