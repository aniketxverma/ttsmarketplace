  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white p-5">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h3 className="font-extrabold text-[#0B1F4D]">Brand Color</h3>
        <span className="text-[10px] font-bold uppercase tracking-wide bg-green-50 text-green-700 px-2 py-0.5 rounded-full">Included</span>
      </div>
      <p className="text-sm text-gray-500 mb-4">Your accent colour — applied to your storefront header and primary buttons.</p>
      ...
      <div className="mt-5 flex items-center gap-3">
        ...
        <button className="rounded-xl px-4 py-2 text-sm font-bold text-white" style={{ backgroundColor: color }}>Follow Shop</button>
      ...
      <button onClick={save} disabled={saving}
        ...
        {saving ? <><Loader2 className="w-4 h-4 animate-spin" /> Saving…</> : saved ? <><Check className="w-4 h-4" /> Saved</> : 'Save brand color'}
      </button>
    </div>
  )
}
