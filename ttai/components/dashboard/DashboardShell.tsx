...
const SECTION_KEY: Record<string, string> = {
  '': 'dashboard', products: 'products', 'master-catalog': 'master_catalog', sourcing: 'sourcing', orders: 'orders', messages: 'messages',
  ...
  pricing: 'pricing_rules', translations: 'translations', sponsorships: 'sponsorships',
