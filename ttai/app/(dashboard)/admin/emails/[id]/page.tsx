  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-0.5">Preview of the email as it was delivered.</p>
      </div>
      ...
      {row.error && (
        <div className="rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-700">
          <strong>Delivery error:</strong> {row.error}
        </div>
      )}

      <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
        <div className="border-b bg-gray-50 px-4 py-2 text-xs font-bold text-gray-500 uppercase tracking-wide">Email content</div>
        {row.html ? (
