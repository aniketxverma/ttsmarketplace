...
export default async function AdminDashboardPage() {
  ...
  const [pendingCount, activeCount, transactionsRes, disputesCount, recentAudit] = await Promise.all([
  ...
  const kpis = [
    ...
    { label: 'Transactions (30d)',   value: `${transactionsRes.data?.length ?? 0} / ${formatCents(txTotal, 'EUR')}`, href: '/admin/transactions', color: 'text-blue-600' },
