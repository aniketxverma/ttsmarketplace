...
export default async function AccountProfilePage() {
  ...
  const tt = await localizeUI(["Approved", "Member since", "Public Profile", "Edit Profile", "Dashboard", "Official Channel", "WhatsApp", "Join TTAI Channel", "Supplier Tools", "Manage your business", "Broker Network", "Manage deals & commissions", "Global Marketplace", "Trade without borders", "Browse by category", "Go to Marketplace"], getLocale())
  await requireAuth()
        ...
        <div className="pt-12 px-6 pb-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              {memberSince && (
                <p className="text-xs text-gray-400 mt-0.5">{tt("Member since")} {memberSince}</p>
              )}
            </div>
      ...
      {ROLE_QUICK_LINKS[profile?.role ?? ''] && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <p className="text-xs font-extrabold text-gray-400 uppercase tracking-widest mb-4">
            {ROLE_LABEL[profile?.role ?? '']} {tt("Dashboard")}
          </p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="bg-[#128C7E] px-5 py-4 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/70 text-xs">{tt("Official Channel")}</p>
            </div>
        ...
        {(profile?.role === 'supplier') ? (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            <div className="bg-gradient-to-r from-orange-500 to-amber-600 px-5 py-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-bold text-sm">{tt("Supplier Tools")}</p>
                <p className="text-white/70 text-xs">{tt("Manage your business")}</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            <div className="bg-gradient-to-r from-purple-600 to-violet-700 px-5 py-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-bold text-sm">{tt("Broker Network")}</p>
                <p className="text-white/70 text-xs">{tt("Manage deals & commissions")}</p>
              </div>
            </div>
            <div className="flex-1 px-5 py-4 space-y-2">
              {([
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            <div className="bg-gradient-to-r from-[#0B1F4D] to-[#1a3580] px-5 py-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-bold text-sm">{tt("Global Marketplace")}</p>
                <p className="text-white/70 text-xs">{tt("Trade without borders")}</p>
              </div>
            </div>
            ...
            <div className="px-5 py-4 flex-1">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wide mb-2.5">{tt("Browse by category")}</p>
