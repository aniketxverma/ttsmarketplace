    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-8 py-16 sm:py-24">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-5">
              Invest. Partner.<br />
              <span className="text-[#F5A623]">Scale Together.</span>
            </h1>
      ...
      <div id="projects" className="max-w-6xl mx-auto px-4 sm:px-8 pb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-extrabold text-[#0B1F4D]">Live Opportunities</h2>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
            <span className="text-sm font-semibold text-gray-500">{PROJECTS.filter(p => p.status !== 'Closed').length} open</span>
          </div>
        </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
                        <div>
                          <span className="text-gray-400 text-xs font-semibold">Investment</span>
                          <p className="font-extrabold text-[#0B1F4D] text-sm">{project.investment_range}</p>
                        </div>
                        <div>
                          <span className="text-gray-400 text-xs font-semibold">Timeline</span>
                          <p className="font-extrabold text-[#0B1F4D] text-sm">{project.timeline}</p>
                        </div>
                        <div>
                          <span className="text-gray-400 text-xs font-semibold">Regions</span>
                    ...
                    <div className="shrink-0 sm:text-right">
                      <div className="mb-3">
                        <p className="text-xs text-gray-400 font-semibold mb-1">
                          <Users className="w-3 h-3 inline mr-1" />{project.slots_filled}/{project.slots_total} slots filled
                        </p>
      ...
      <div className="bg-gradient-to-br from-[#0B1F4D] to-[#1a3580] py-16">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-extrabold text-white mb-4">Don't see the right project?</h2>
