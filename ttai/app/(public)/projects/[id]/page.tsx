        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-sm font-extrabold text-gray-500 uppercase tracking-widest mb-4">Overview</h2>
            ...
            {/* Highlights */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-sm font-extrabold text-gray-500 uppercase tracking-widest mb-4">What You Get</h2>
            ...
            {/* Requirements */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-sm font-extrabold text-gray-500 uppercase tracking-widest mb-4">Requirements</h2>
              <div className="space-y-3">
            ...
            {/* Regions */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-sm font-extrabold text-gray-500 uppercase tracking-widest mb-4">Regions Covered</h2>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              <h2 className="text-xs font-extrabold text-gray-500 uppercase tracking-widest mb-4">Project Details</h2>
              <div className="space-y-4">
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wide font-extrabold mb-0.5">Investment</p>
                  <p className="text-sm font-extrabold text-[#0B1F4D]">{project.investment_range}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wide font-extrabold mb-0.5">Timeline</p>
                  <p className="text-sm font-semibold text-gray-700 flex items-center gap-1.5">
                    <Calendar className="w-3.5 h-3.5 text-gray-400" />{project.timeline}
                  </p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wide font-extrabold mb-0.5">Category</p>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <p className="text-[10px] text-gray-400 uppercase tracking-wide font-extrabold flex items-center gap-1">
                      <Users className="w-3 h-3" />Slots Available
                    </p>
                    <p className="text-xs font-extrabold text-[#0B1F4D]">{slotsLeft} left</p>
                  </div>
                  ...
                  <p className="text-[11px] text-gray-400 mt-1">{project.slots_filled} of {project.slots_total} slots filled</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#0B1F4D] to-[#1a3580] rounded-2xl p-5 text-white shadow-lg">
              ...
              <p className="font-extrabold text-base mb-1">Express Interest</p>
            ...
            {/* Other projects */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              <p className="text-xs font-extrabold text-gray-500 uppercase tracking-widest mb-4">Other Projects</p>
              <div className="space-y-3">
