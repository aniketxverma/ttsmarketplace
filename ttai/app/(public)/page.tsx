...
const BUY_CHANNELS = [
  {
    key: 'online',
    href: '/store',
    eyebrow: 'End user · retail',
    title: 'Shop Online',
    units: 'By unit or box',
    blurb: 'Thousands of products from registered brands — retail prices, ready to ship to your door.',
    cta: 'Shop now',
    Icon: ShoppingCart,
    accent: '#7c3aed',
  ...
  },
  {
    ...
    blurb: 'Volume pricing for shops, retailers and distributors — buy by the box or pallet.',
  ...
  },
  {
    key: 'b2b',
    href: '/b2b',
    eyebrow: 'Large volume',
    title: 'Truck Loads',
    units: 'Pallet or full truck',
    blurb: 'From a pallet to a full container — large-volume trade and efficient sourcing to grow.',
    cta: 'Trade in bulk',
    Icon: Boxes,
    accent: '#F5A623',
