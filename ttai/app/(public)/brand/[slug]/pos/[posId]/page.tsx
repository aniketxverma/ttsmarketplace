      ...
      <div className="container mx-auto px-4 sm:px-8 py-8 max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <h2 className="font-bold text-[#0B1F4D] mb-4">Contact</h2>
            <div className="space-y-3">
              {det?.manager_name && (
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div><p className="text-xs text-gray-400">Manager</p><p className="font-semibold text-gray-800">{det.manager_name}</p></div>
                </div>
              )}
              {det?.phone && (
          ...
          {/* Hours */}
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <h2 className="font-bold text-[#0B1F4D] mb-4">Opening Hours</h2>
            {det?.opening_hours ? (
              ...
              <p className="text-sm text-gray-400">No hours listed</p>
            )}
          </div>
          ...
          {det?.services_offered?.length > 0 && (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              <h2 className="font-bold text-[#0B1F4D] mb-3">Services</h2>
          ...
          {mapsUrl && (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              <h2 className="font-bold text-[#0B1F4D] mb-3">Location</h2>
